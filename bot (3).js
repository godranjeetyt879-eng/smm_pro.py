...
const MAIN_INLINE = { reply_markup:{ inline_keyboard:[
  [
    { text:'💰 𝐖𝐚𝐥𝐥𝐞𝐭',    callback_data:'main_wallet',   custom_emoji_id:'5417924076503062111' },
    { text:'🛒 𝐍𝐞𝐰 𝐎𝐫𝐝𝐞𝐫',  callback_data:'main_neworder', custom_emoji_id:'5431499171045581032' },
  ],
  [
    { text:'📦 𝐌𝐲 𝐎𝐫𝐝𝐞𝐫𝐬',  callback_data:'main_myorders', custom_emoji_id:'5864114012542736772' },
    { text:'🔗 𝐑𝐞𝐟𝐞𝐫𝐫𝐚𝐥',   callback_data:'main_referral',  custom_emoji_id:'6267115986541877538' },
  ],
  [
    { text:'📊 𝐌𝐲 𝐒𝐭𝐚𝐭𝐬',   callback_data:'main_stats',    custom_emoji_id:'5841697495893154141' },
    { text:'🎧 𝐒𝐮𝐩𝐩𝐨𝐫𝐭',    callback_data:'main_support',  custom_emoji_id:'5307746710682869587' },
  ],
  [
    { text:'ℹ️ 𝐇𝐞𝐥𝐩',       callback_data:'main_help',     custom_emoji_id:'5334544901428229844' },
  ],
]}}; 
...
bot.onText(/\/start(?:\s+(.+))?/, async (msg, match) => {
  ...
  const wMsg = C.welcomeMsg || [
    '<tg-emoji emoji-id="5188481279963715781">🚀</tg-emoji> <b>Boost Your Social Media with Us!</b>',
    '━━━━━━━━━━━━━━━━━━━━',
