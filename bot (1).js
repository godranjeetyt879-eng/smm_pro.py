...
function getLinkInfo(linkType) {
  const m = {
    TELEGRAM_INVITE: {
      ...
      msg:
        `⚠️ <b>Yeh service Private Invite Link maangti hai!</b>\n\n` +
        `<b>Invite Link kaise milega:</b>\n` +
        `1. Apna Telegram Group kholein\n` +
        `2. Group Settings → Invite Links → Copy karein\n\n` +
        `✅ <b>Sahi format:</b>\n` +
        `<code>https://t.me/+xxxxxxxxxx</code>\n` +
        `ya\n` +
        `<code>https://t.me/joinchat/xxxxxxxxxx</code>\n\n` +
        `❌ <b>Galat (ye mat bhejein):</b>\n` +
        `<code>@groupname</code> ← yeh public link hai, kaam nahi karega\n` +
        `<code>https://t.me/groupname</code> ← yeh bhi nahi\n\n` +
        `🔗 Apna <b>invite link</b> bhejein:`,
    ...
    TELEGRAM_POST: {
      ...
      msg:
        `🔗 <b>Telegram Post ya Message ka link bhejein</b>\n\n` +
        `✅ <b>Sahi format:</b>\n` +
        `<code>https://t.me/channelname/123</code>\n\n` +
        `<b>Kaise milega:</b>\n` +
        `Post kholein → ⋮ (3 dots) → Copy Link\n\n` +
        `❌ <b>Galat:</b>\n` +
        `<code>https://t.me/channelname</code> ← post number nahi hai\n\n` +
        `🔗 Apna post link bhejein:`,
    ...
    TELEGRAM_PUBLIC: {
      ...
      msg:
        `🔗 <b>Apna Telegram Channel ya Public Group link bhejein</b>\n\n` +
        `✅ <b>Sahi format:</b>\n` +
    ...
    INSTAGRAM_POST: {
      ...
      msg:
        ...
        `❌ <b>Galat:</b> Profile URL mat bhejein\n\n` +
        `🔗 Post link bhejein:`,
