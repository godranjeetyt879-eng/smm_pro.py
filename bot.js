...
const MAIN_INLINE = { reply_markup:{ inline_keyboard:[
  [
    { text:'💰 𝐖𝐚𝐥𝐥𝐞𝐭',    callback_data:'main_wallet'   },
    { text:'🛒 𝐍𝐞𝐰 𝐎𝐫𝐝𝐞𝐫',  callback_data:'main_neworder' },
  ],
  [
    { text:'📦 𝐌𝐲 𝐎𝐫𝐝𝐞𝐫𝐬',  callback_data:'main_myorders' },
    { text:'🔗 𝐑𝐞𝐟𝐞𝐫𝐫𝐚𝐥',   callback_data:'main_referral'  },
  ],
  [
    { text:'📊 𝐌𝐲 𝐒𝐭𝐚𝐭𝐬',   callback_data:'main_stats'   },
    { text:'🎧 𝐒𝐮𝐩𝐩𝐨𝐫𝐭',    callback_data:'main_support' },
  ],
  [
    { text:'ℹ️ 𝐇𝐞𝐥𝐩',       callback_data:'main_help' },
  ],
]}}; 
